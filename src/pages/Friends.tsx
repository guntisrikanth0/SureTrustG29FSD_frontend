        ...
        return (
          <div>
            ...
            <ul className="space-y-3">
              <li className="bg-white p-3 rounded shadow">Friend 1</li>
              <li className="bg-white p-3 rounded shadow">Friend 2</li>
              <li className="bg-white p-3 rounded shadow">Friend 3</li>
            </ul>
          </div>
        );
